...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['./ReduxUtil.babel.js', './BaseComponent.babel.js', './JQueryComponent.babel.js'], factory);
  } else if (typeof exports !== "undefined") {
    factory(require('./ReduxUtil.babel.js'), require('./BaseComponent.babel.js'), require('./JQueryComponent.babel.js'));
  } else {
    var mod = {
      exports: {}
    };
    factory(global.ReduxUtilBabel, global.BaseComponentBabel, global.JQueryComponentBabel);
    global.indexBabel = mod.exports;
  }
})(this, function (_ReduxUtilBabel, _BaseComponentBabel, _JQueryComponentBabel) {
  'use strict';
